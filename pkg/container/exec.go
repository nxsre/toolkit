...
func Exec(ctx context.Context, client *containerd.Client, args []string, options types.ContainerExecOptions, stdin *os.File, stdout io.Writer, stderr io.Writer) error {
	walker := &containerwalker.ContainerWalker{
		...
		OnFound: func(ctx context.Context, found containerwalker.Found) error {
			...
			return execActionWithContainer(ctx, client, found.Container, args, options, stdin, stdout, stderr)
		},
	}
	req := args[0]
...
func execActionWithContainer(ctx context.Context, client *containerd.Client, container containerd.Container, args []string, options types.ContainerExecOptions, stdin *os.File, stdout io.Writer, stderr io.Writer) error {
	...
	cioOpts := []cio.Opt{cio.WithStreams(in, stdout, stderr)}
	if options.TTY {
